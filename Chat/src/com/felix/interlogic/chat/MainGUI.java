...
public class MainGUI {
    ...
    public void display() {
        ...
        sendMessage.addActionListener(new sendMessageButtonListener());
         newFrame.addKeyListener(new sendMessageButtonListener());
        sendMessage.setMnemonic(KeyEvent.VK_P);
        newFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        newFrame.setSize(470, 300);
    }

    class sendMessageButtonListener implements ActionListener,KeyListener {
		...
		public void keyPressed(KeyEvent arg0) {
			if(arg0.getKeyCode()==KeyEvent.VK_ENTER)work();
